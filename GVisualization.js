...
function drawCrosshairs(revArr,yAxisLabel) {
        ...
        data = {}, tmp;
            ...
            if(providerID === "smartcitizen"){
                ...
                Promise.all([prom]).then(function(values){
                    ...
                    if(values[0].length === 0){
                        ...
                        Promise.all([prom2]).then(function(values){
                            ...
                            drawCrosshairs(valArr,yAxisLabel);
                ...
                Promise.all([prom]).then(function(values){
                    ...
                    drawCrosshairs(valArr,values[0].results[0].parameter+" ("+values[0].results[0].unit+")");
                    ...
                    if(values[0].feeds.length === 0){
                        ...
                        Promise.all([prom2]).then(function(values){
                            for(i=0;i<values[0].feeds.length;i++){
                                ...
                                drawCrosshairs(valArr,values[0].channel["field"+fieldID]);
