...
//created by Simone Battaglia, extended & modified as seen fit for gaIoTa app by Udayanto Dwi Atmojo
 ...
 //define(['../lib/supercluster.min', '../worldwind.min'], function (supercluster, wwe) {
    ...
    MarkerCluster.prototype.removePicking = function () {
        if (self.globe.eventListeners.addedListeners == true) {
            self.globe.eventListeners.addedListeners = false;
            self.globe.removeEventListener("mousemove", this.handlePickFunc);
            self.globe.removeEventListener("click", this.handleClickFunc);
            //this.handleClickFunc = handleClick;
            //this.handlePickFunc = handlePick;
        }
    }
    ...
    MarkerCluster.prototype.addPicking = function () {
        if (self.globe.eventListeners.addedListeners == false) {
            self.globe.eventListeners.addedListeners = true;
            self.globe.addEventListener("mousemove", this.handlePickFunc);
            self.globe.addEventListener("click", this.handleClickFunc);
            //this.handleClickFunc = handleClick;
            //this.handlePickFunc = handlePick;
        }
    }
